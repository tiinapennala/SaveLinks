 ...
 * Generated at: 2018-02-18 10:57:31 UTC
...
if(session.getAttribute("SignIn_name")==null){		
	...
	out.println("</script>");	
      ...
      out.write("\t<br><br>\r\n");
      out.write("\t\r\n");
      out.write("\t<input type=\"text\" name=\"Search\" placeholder=\"  Search link...\" id=\"keyword\">\r\n");
      out.write("\t<input type=\"button\" class=\"searchbutton\" value=\"Search\" id=\"getBtn\">\r\n");
	...
	if(request.getParameter("ok")!=null){
      ...
      out.write("\t\t\t\tdocument.location=\"Servlet_GetLinks?keyword=\" + $(\"#keyword\").val();\t\t\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t//Objektin ominaisuuksien ja arvojen läpikäynti (ei tarvita tässä tapauksessa, vain esimerkkinä)\r\n");
      out.write("\t\t\t/*\r\n");
      ...
      out.write("\t\t\t$(\"#deletableName\").html($(this)[0].title + \"?<br>\");\r\n");
      ...
      out.write("\t\t\tdocument.location=\"Servlet_DeleteLink?Link_id=\"+deletable_id;\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
